...
public class PlayerControl : MonoBehaviour
{
	...
	private int vFloat;
	private int aimBool;
    private int lumberingBool;
    //private int strikeBool;
	private int flyBool;
	...
	void Awake()
	{
       ...
       lumberingBool = Animator.StringToHash("Lumbering");
		// fly
     //   strikeBool = Animator.StringToHash("Strike");
	...
	void Update()
	{
      ...
      //  strike = Input.GetButton("Strike");
		aim = Input.GetButton("Aim");
       lumbering = Input.GetButton("Lumbering");
	...
	void FixedUpdate()
	{
        ...
        anim.SetBool(lumberingBool, isLumbering());
    ...
    void LumberingManagement()
    {
        if (Input.GetKeyDown ("Lumbering"))
        {
            anim.SetBool(lumberingBool, true);
